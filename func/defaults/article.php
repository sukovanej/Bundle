<article>
	...
	<h5>
		<span class="label label-success">Vytvořil(a) <strong><?= $Author->Username ?></strong></span> 
		<?php if($Article->ShowDatetime): ?><strong class="label label-primary"><?= $Article->Datetime ?></strong><?php endif; ?>
