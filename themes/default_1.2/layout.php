...
<head>
	...
	<link rel="stylesheet" href="<?= $Page->ThemeRoot ?>/style_default.css?get=get" />
...
<body>
	<div id="wrapper">
		...
		<footer>
			<content>
				<?php $Page->Footer() ?>
				<p>Powered by <a href="http://bundle-cms.cz/" target="_blank">Bundle</a>, <a href="./administration">Administrace</a></p>
			</content>
		</footer>		
	</div>			
